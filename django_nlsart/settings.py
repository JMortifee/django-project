"""
Django settings for django_nlsart project.
...
ALLOWED_HOSTS = ['nlsart.herokuapp.com', 'localhost', '127.0.0.1:8000']
...
ROOT_URLCONF = 'django_nlsart.urls'
...
WSGI_APPLICATION = 'django_nlsart.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # bucket config
    AWS_STORAGE_BUCKET_NAME = 'nlsart'
...
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'nlsart@example.com'
else:
